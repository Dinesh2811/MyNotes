...
[<img src="https://play.google.com/intl/en_us/badges/images/generic/en_badge_web_generic.png" alt="Get it on Google Play"  height="70"/>](https://play.google.com/store/apps/details?id=com.dinesh.mynotes)

## MyNotes - Secure backup using AES 256-bit encryption

### Overview
MyNote is a lightweight open-source Android app designed for easy note-taking, secure data storage, and effortless backup and restore options. With AES 256-bit encryption, you can keep your notes safe and private. The app utilizes LiveData, ViewModel, Coroutine, and Room Database for a seamless and responsive user experience.
...
## Spread the Word
If you find MyNote app useful, consider sharing it with fellow developers and communities.

### Happy note-taking with MyNote!
